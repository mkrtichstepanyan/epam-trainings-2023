...
class LambdaDemo {
    public static void main(String[] args) {
        ...
        which the lambda expression implements the getValue() method in myNumber.*/
        ...
        //A lambda expression must be compatible with the method defined by the functional interface. Therefor,
        // this won't work:
        // myNum = () -> "123.03"; //Error!
    }
}
