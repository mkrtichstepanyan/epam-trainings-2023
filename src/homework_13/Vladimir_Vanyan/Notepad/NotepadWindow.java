package homework_13.Vladimir_Vanyan.Notepad;
...
public class NotepadWindow extends JFrame {
    ...
    public NotepadWindow() {
        currentFile = new File("resault.txt");
    ...
    class NotepadMenuBar extends JMenuBar {
        ...
        private void loadMenuLabels(Properties properties) {
            ...
            amLang.setText(properties.getProperty("am.menu.name"));
        ...
        private void onSaveFileActionPerformed(ActionEvent actionEvent) {
            String text = textArea.getText();
