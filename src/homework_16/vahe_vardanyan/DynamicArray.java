...
public class DynamicArray {
    ...
    public void removeRange(int fromaindex, int toIndex) {
        if (fromaindex < 0 || toIndex > size || fromaindex > toIndex) {
            throw new IndexOutOfBoundsException("Wrong index range");
        }
        System.arraycopy(array, toIndex, array, fromaindex, size - toIndex);
        size -= toIndex - fromaindex;
    }
