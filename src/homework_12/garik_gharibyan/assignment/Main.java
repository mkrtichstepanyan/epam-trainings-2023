...
public class Main {
    public static void main(String[] args) {
        ...
        String readFile = "src/homework_12/garik_gharibyan/assignment/files/readFile.txt";
        String writeFile = "src/homework_12/garik_gharibyan/assignment/files/writeFile.txt";
        String phoneNumberFile = "src/homework_12/garik_gharibyan/assignment/files/phoneNumber.txt";
