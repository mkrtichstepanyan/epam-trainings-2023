package homework_12.Qnarik_Khachatryan.NIO_tasks.Assignment_1;
...
public class Assignment_1 {
    ...
    public static void main(String[] args) {
        String data = readFile("src/homework_12/Qnarik_Khachatryan/NIO_tasks/" +
                "Assignment_1/fileToRead.txt");
        String modifiedData = processData(data);
        writeFile("src/homework_12/Qnarik_Khachatryan/NIO_tasks/" +
