    ...
    */
    ...
    public static void sumAgain() {
        ...
        do {
            ...
            System.out.println("If you want to perform press Y");
    ...
    public static void armstrongNumber() {
        ...
        for (int number = 1; number <= 500; number++) {
            ...
            if (digit3 * digit3 * digit3 + digit2 * digit2 * digit2 + digit1 * digit1 * digit1 == number) {
                System.out.println(number + "The number is an armstrong number ");
            }
        }
    }
    ...
    */
    public static void guessMyNumber() {
        ...
        do {
            ...
            tries++;
            if (guess > number) {
                System.out.println("The correct number is lower, please try again.");
            } else if (guess < number) {
                System.out.println("The correct number is higher, please try again.");
            }
        } while (guess != number);
        System.out.println("Correct ! You guessed the number on the " + tries + " try.");
    }
}
