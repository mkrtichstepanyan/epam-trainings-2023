package homework_3.Hovhannes_Gspeyan;
...
//        guessMyNumber();             // Question 15
    ...
    */
    ...
    public static void sumAgain() {
        ...
        do {
            System.out.println("Please enter numbers you want to calculate the sum");
            number1 = console.nextInt();
            number2 = console.nextInt();
            int sum = number1 + number2;
            System.out.println("The sum is: " + sum);
            System.out.println("Do you wish to perform the operation again? \n press any key, else press 'n'");
    ...
    */
    ...
    public static void findMaxMin() {
        ...
        do {
            ...
            System.out.print("Do you wish to enter another number? (yes/no): ");
            choice = console.next().charAt(0);
        } while (choice == 'y' || choice == 'Y');
    ...
    */
    public static void guessMyNumber() {
        ...
        System.out.println("Congratulations! You guessed the correct number by " + tries + " tries");
    }
}
