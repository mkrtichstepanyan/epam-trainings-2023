    ...
    */
    ...
    public static void sumAgain() {
        ...
        do {
            ...
            System.out.println("The sum of this numbers is " + (number1 + number2));
    ...
    public static void armstrongNumber() {
        ...
        for (int i = 10; i <= 500; i++) {
            ...
            if (num >= 100) {
                ...
                digit2 = (num % 100) / 10;
                digit3 = num % 10;
                cubeSum = (int) (Math.pow(digit1, 3) + Math.pow(digit2, 3) + Math.pow(digit3, 3));
            } else {
                digit1 = num / 10;
                digit2 = num % 10;
                cubeSum = (int) (Math.pow(digit1, 3) + Math.pow(digit2, 3));
            }
