...
public class Task_3 {
    ...
    public static void main(String[] args) {
        System.out.println("calculate HCF of Two given number");
        FindHcf();                   // Question 8
        System.out.println("calculate the of Two given number");
        sumAgain();                  // Question 9
        System.out.println("Display the count of positive, negative numbers and zeros");
        countNumbers();              // Question 10
        System.out.println("Display the largest and smallest numbers");
        findMaxMin();                // Question 11
        System.out.println("Display the Armstrong numbers between 1 to 500");
        armstrongNumber();           // Question 12
        System.out.println("Display the Fibonacci numbers of n terms ");
        fibonacciSeries();           // Question 13
        System.out.println("Calculate the sum of n series");
    ...
    public static void guessMyNumber() {
        ...
        do {
            ...
            if (guess != number) {
                ...
                System.out.println("You find  a number after " + tries + " tries and it is " + guess);
                break;
            }
