...
//        sumOfSeries();               // Question 14
    ...
    */
    ...
    public static void FindHcf() {
        ...
        dividend = console.nextInt(); //делимое

        System.out.print("Enter the second number ");
        divisor = console.nextInt(); // делитель

        if (dividend % divisor == 0 || divisor % dividend == 0) {
            if (dividend > divisor) {
                hcf = divisor;
    ...
    */
    public static void armstrongNumber() {
        ...
        for (int i = 1; i <= 500; i++) {
            ...
            sumOfCubs = sumOfCubs1 + sumOfCubs2 + sumOfCubs3;
            if (i == sumOfCubs) {
...
//        System.out.println(number);
        ...
        System.out.println("Cheer! You guessed the number on the " + tries + " try.");
    }
}