    ...
    */
    ...
    public static void sumAgain() {
        ...
        do {
            ...
            sumTwoDigits += (number1 + number2);
            System.out.println("Sum of the numbers = " + sumTwoDigits);

            System.out.print("Repeat operation again? ");
    ...
    public static void armstrongNumber() {
        ...
        for (int i = 1; i <= 500; i++) {
            if (i < 10) {
                ...
                digit2 = i % 10;
                digit1 = i / 10;
                if (digit1 * digit1 * digit1 + digit2 * digit2 * digit2 == i) {
                    System.out.print(i + ", ");
                }
            } else if (i <= 500) {
                digit3 = i % 10;
    ...
    */
    public static void guessMyNumber() {
        ...
        do {
            ...
            if (number == guess) {
                System.out.println("\nYou guessed the number. Number of attempts: = " + tries);
                break;
