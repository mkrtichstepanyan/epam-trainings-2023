...
//        reverseNumber();             // Question 5
    ...
    */
    public static int sumNumbers(int number) {
        int sum = sumNumbersUtil(number);

        System.out.println("Sum: " + sum);
        return sum;
    }

    private static int sumNumbersUtil(int num) {
        int sum = 0;

        if (num == 0) {
            return 0;
        } else {
            sum = sumNumbersUtil(num - 1) + num;
            return sum;
        }
    }
    ...
    */
    ...
    private static int powerDemoUtil(int baseNum, int powerNum) {
        if (powerNum == 0) {
            return 1;
        } else {
            return baseNum * powerDemoUtil(baseNum, powerNum - 1);
        }
    }
    ...
    public static void reverseNumber() {
        ...
        reverse = reverseNumberUtil(number, reverse);
    ...
    */
    public static void testPrime() {
        ...
        flag = testPrimeUtil(number, 2);

        System.out.println("The " + number + " is prime.--> " + flag);

    }

    private static boolean testPrimeUtil(int num, int i) {
        if (num < 2) {
            return false;
        } else if (num == 2) {
            return true;
